        ...
        <body style="background-color: #E9ECF2;">
          <center>
            ...
            <table style="background-color: #fff;
              ...
              <tr><td style="padding-bottom:10px;margin-bottom:10px;">${process.env.COMPANY_NAME}</td></tr>
            </table>
          </center>
        </body>
...
const sendAdminEmail = async (title, body) => {

  transport.sendMail({
      from: 'opeyemiodedeyi@gmail.com',
      to: `squaco <opeyemiodedeyi@gmail.com>`,
      subject: title,
      html: `
      <!DOCTYPE html>
      <html>
